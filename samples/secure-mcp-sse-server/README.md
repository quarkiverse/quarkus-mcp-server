...
Go to `http://localhost:8080/mcp/sse`, and use the `alice` name and `alice` password to login.

Copy the returned access token using a copy button in the OIDC DevUI.
