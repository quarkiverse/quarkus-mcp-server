...
class McpStreamableTestClientImpl extends McpTestClientBase<McpStreamableAssert, McpStremableTestClient>
        implements McpStremableTestClient {
    ...
    @Override
    public McpStremableTestClient connect(Consumer<InitResult> assertFunction) {
        if (client == null) {
    ...
    public Snapshot snapshot() {
        return new Snapshot(client.state);
    }
    ...
    static class BuilderImpl implements McpStremableTestClient.Builder {
        ...
        @Override
        public McpStremableTestClient.Builder setName(String clientName) {
            if (clientName == null) {
        ...
        @Override
        public McpStremableTestClient.Builder setVersion(String clientVersion) {
        ...
        @Override
        public McpStremableTestClient.Builder setProtocolVersion(String protocolVersion) {
        ...
        @Override
        public McpStremableTestClient.Builder setClientCapabilities(ClientCapability... capabilities) {
            this.clientCapabilities = new HashSet<>(Arrays.asList(capabilities));
            return this;
        }

        @Override
        public McpStremableTestClient.Builder setAutoPong(boolean val) {
            this.autoPong = val;
            return this;
        }

        @Override
        public McpStremableTestClient.Builder setBaseUri(URI baseUri) {
            if (baseUri == null) {
        ...
        @Override
        public McpStremableTestClient.Builder setMcpPath(String mcpPath) {
            if (mcpPath == null) {
        ...
        @Override
        public McpStremableTestClient.Builder setAdditionalHeaders(Function<JsonObject, MultiMap> additionalHeaders) {
            if (additionalHeaders == null) {
        ...
        @Override
        public McpStremableTestClient.Builder setBasicAuth(String username, String password) {
            if (username == null) {
        ...
        @Override
        public McpStremableTestClient build() {
            if (baseUri == null) {
