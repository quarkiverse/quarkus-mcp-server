...
public class McpAssured {
     ...
     * @see McpStremableTestClient.Builder#setBaseUri(URI)
     */
     ...
     */
    public static McpStremableTestClient.Builder newStreamableClient() {
     ...
     */
    public static McpStremableTestClient newConnectedStreamableClient() {
    ...
    public interface McpTestClient<ASSERT extends McpAssert<ASSERT>, CLIENT extends McpTestClient<ASSERT, CLIENT>> {
        ...
        /**
         *
         * @return the server info or {@code null} if not connected
         */
         ...
         * the {@link #thenAssertResults()} method is called.
         *
         ...
         * {@link #thenAssertResults()} method is called.
         *
         * @return the assert group
         * @see McpAssert#thenAssertResults()
         */
     ...
     */
    public interface McpStremableTestClient
            extends McpTestClient<McpStreamableAssert, McpStremableTestClient> {
        ...
        public interface Builder extends McpTestClient.Builder<Builder> {
             ...
             * @return a new test client
             */
            McpStremableTestClient build();
        }

    }

    /**
     * Represents a group of MCP requests and corresponding assert functions. Each request is sent separately.
     */
    ...
    public record Snapshot(List<JsonObject> requests, List<JsonObject> responses, List<JsonObject> notifications) {
        ...
        public Snapshot(McpClientState clientState) {
            this(clientState.getRequests(), clientState.getResponses(), clientState.getNotifications());
        }
