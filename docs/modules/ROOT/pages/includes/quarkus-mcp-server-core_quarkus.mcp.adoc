...
a| [[quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-src]] [.property-path]##link:#quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-src[`quarkus.mcp.server.server-info.icons.src`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server.server-info.icons.src+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MCP_SERVER_SERVER_INFO_ICONS_SRC+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
...
a| [[quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-mime-type]] [.property-path]##link:#quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-mime-type[`quarkus.mcp.server.server-info.icons.mime-type`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server.server-info.icons.mime-type+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MCP_SERVER_SERVER_INFO_ICONS_MIME_TYPE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
...
a| [[quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-sizes]] [.property-path]##link:#quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-sizes[`quarkus.mcp.server.server-info.icons.sizes`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server.server-info.icons.sizes+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MCP_SERVER_SERVER_INFO_ICONS_SIZES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
...
a| [[quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-theme]] [.property-path]##link:#quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-theme[`quarkus.mcp.server.server-info.icons.theme`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server.server-info.icons.theme+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MCP_SERVER_SERVER_INFO_ICONS_THEME+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
