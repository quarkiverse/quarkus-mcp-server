...
a|icon:lock[title=Fixed at build time] [[quarkus-mcp-server-core_quarkus-mcp-server-support-multi-server-bindings]] [.property-path]##link:#quarkus-mcp-server-core_quarkus-mcp-server-support-multi-server-bindings[`+++quarkus.mcp.server.support-multi-server-bindings+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server.support-multi-server-bindings+++[]
endif::add-copy-button-to-config-props[]
...
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MCP_SERVER_SUPPORT_MULTI_SERVER_BINDINGS+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|
...
a|icon:lock[title=Fixed at build time] [[quarkus-mcp-server-core_quarkus-mcp-server-tools-name-pattern]] [.property-path]##link:#quarkus-mcp-server-core_quarkus-mcp-server-tools-name-pattern[`+++quarkus.mcp.server.tools.name-pattern+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server.tools.name-pattern+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.mcp.server."server-name".tools.name-pattern+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server."server-name".tools.name-pattern+++[]
endif::add-copy-button-to-config-props[]
...
The names of tools that are defined declaratively with annotations are validated at build time. The names of tools that are added programmatically are validated at runtime.

Typically, the pattern `^++[++A-Za-z0-9_.-++]{++1,128`$++}++ follows the spec recommendations.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MCP_SERVER_TOOLS_NAME_PATTERN+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MCP_SERVER_TOOLS_NAME_PATTERN+++`
endif::add-copy-button-to-env-var[]
--
...
a| [[quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-i-src]] [.property-path]##link:#quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-i-src[`+++quarkus.mcp.server.server-info.icons[i].src+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server.server-info.icons[i].src+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.mcp.server."server-name".server-info.icons.src+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server."server-name".server-info.icons.src+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MCP_SERVER_SERVER_INFO_ICONS_I__SRC+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MCP_SERVER_SERVER_INFO_ICONS_I__SRC+++`
endif::add-copy-button-to-env-var[]
--
|string
|required icon:exclamation-circle[title=Configuration property is required]

a| [[quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-i-mime-type]] [.property-path]##link:#quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-i-mime-type[`+++quarkus.mcp.server.server-info.icons[i].mime-type+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server.server-info.icons[i].mime-type+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.mcp.server."server-name".server-info.icons.mime-type+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server."server-name".server-info.icons.mime-type+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MCP_SERVER_SERVER_INFO_ICONS_I__MIME_TYPE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MCP_SERVER_SERVER_INFO_ICONS_I__MIME_TYPE+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-i-sizes]] [.property-path]##link:#quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-i-sizes[`+++quarkus.mcp.server.server-info.icons[i].sizes+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server.server-info.icons[i].sizes+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.mcp.server."server-name".server-info.icons.sizes+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server."server-name".server-info.icons.sizes+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MCP_SERVER_SERVER_INFO_ICONS_I__SIZES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MCP_SERVER_SERVER_INFO_ICONS_I__SIZES+++`
endif::add-copy-button-to-env-var[]
--
|list of string
|required icon:exclamation-circle[title=Configuration property is required]

a| [[quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-i-theme]] [.property-path]##link:#quarkus-mcp-server-core_quarkus-mcp-server-server-info-icons-i-theme[`+++quarkus.mcp.server.server-info.icons[i].theme+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server.server-info.icons[i].theme+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.mcp.server."server-name".server-info.icons.theme+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server."server-name".server-info.icons.theme+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MCP_SERVER_SERVER_INFO_ICONS_I__THEME+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MCP_SERVER_SERVER_INFO_ICONS_I__THEME+++`
endif::add-copy-button-to-env-var[]
--
a|`light`, `dark`
|

a| [[quarkus-mcp-server-core_quarkus-mcp-server-server-info-description]] [.property-path]##link:#quarkus-mcp-server-core_quarkus-mcp-server-server-info-description[`+++quarkus.mcp.server.server-info.description+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server.server-info.description+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.mcp.server."server-name".server-info.description+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server."server-name".server-info.description+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MCP_SERVER_SERVER_INFO_DESCRIPTION+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
...
a| [[quarkus-mcp-server-core_quarkus-mcp-server-server-info-website-url]] [.property-path]##link:#quarkus-mcp-server-core_quarkus-mcp-server-server-info-website-url[`+++quarkus.mcp.server.server-info.website-url+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server.server-info.website-url+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.mcp.server."server-name".server-info.website-url+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server."server-name".server-info.website-url+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MCP_SERVER_SERVER_INFO_WEBSITE_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
...
a| [[quarkus-mcp-server-core_quarkus-mcp-server-tools-input-validation-error]] [.property-path]##link:#quarkus-mcp-server-core_quarkus-mcp-server-tools-input-validation-error[`+++quarkus.mcp.server.tools.input-validation-error+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server.tools.input-validation-error+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.mcp.server."server-name".tools.input-validation-error+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server."server-name".tools.input-validation-error+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MCP_SERVER_TOOLS_INPUT_VALIDATION_ERROR+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
...
a| [[quarkus-mcp-server-core_quarkus-mcp-server-elicitation-default-completion-timeout]] [.property-path]##link:#quarkus-mcp-server-core_quarkus-mcp-server-elicitation-default-completion-timeout[`+++quarkus.mcp.server.elicitation.default-completion-timeout+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server.elicitation.default-completion-timeout+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.mcp.server."server-name".elicitation.default-completion-timeout+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server."server-name".elicitation.default-completion-timeout+++[]
endif::add-copy-button-to-config-props[]

[.description]
--
The default timeout for a URL mode elicitation completion. This is the maximum time the server will keep a pending elicitation entry waiting for an external service to call `io.quarkiverse.mcp.server.ElicitationCompletion++#++send`. Negative and zero durations imply no timeout.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MCP_SERVER_ELICITATION_DEFAULT_COMPLETION_TIMEOUT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MCP_SERVER_ELICITATION_DEFAULT_COMPLETION_TIMEOUT+++`
endif::add-copy-button-to-env-var[]
--
|link:https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/Duration.html[Duration] link:#duration-note-anchor-quarkus-mcp-server-core_quarkus-mcp[icon:question-circle[title=More information about the Duration format]]
|`+++10M+++`
...
a| [[quarkus-mcp-server-core_quarkus-mcp-server-tracing-enabled]] [.property-path]##link:#quarkus-mcp-server-core_quarkus-mcp-server-tracing-enabled[`+++quarkus.mcp.server.tracing.enabled+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server.tracing.enabled+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.mcp.server."server-name".tracing.enabled+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.mcp.server."server-name".tracing.enabled+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_MCP_SERVER_TRACING_ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_MCP_SERVER_TRACING_ENABLED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
