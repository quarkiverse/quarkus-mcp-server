...
* **Tasks** - Execute long-running tools asynchronously (xref:guides-mcp-tasks.adoc[MCP Tasks extension])
...
|xref:guides-connecting-mcp-clients.adoc[**Connecting Clients**] |Connect Claude Code and other MCP clients to your server
