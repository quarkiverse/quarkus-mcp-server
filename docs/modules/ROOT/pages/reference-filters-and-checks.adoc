...
boolean supportsElicitation = initialRequest.supportsElicitationFormMode();
...
// Protocol version
String protocolVersion = initialRequest.protocolVersion().version();
----
...
public Uni<CheckResult> perform(InitialRequest initialRequest) {
    ...
    boolean hasElicitation = initialRequest.supportsElicitationFormMode();
