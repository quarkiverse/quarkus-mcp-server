...
A tool annotated with `@Task` is executed asynchronously for clients that declared the https://modelcontextprotocol.io/extensions/tasks/overview[Tasks] extension (`io.modelcontextprotocol/tasks`).
