...
`io.quarkiverse.mcp.server.tasks.TaskContext`:: The task a `@Task`-annotated tool is executed as; requires the `quarkus-mcp-server-tasks` extension, see xref:guides-mcp-tasks.adoc[MCP Tasks].
