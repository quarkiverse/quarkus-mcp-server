...
class DotNames {
    ...
    static final DotName PROMPT_COMPLETION_MANAGER = DotName.createSimple(PromptCompletionManager.class);
    ...
    static final DotName RESOURCE_TEMPLATE_COMPLETION_MANAGER = DotName.createSimple(ResourceTemplateCompletionManager.class);
    ...
    static final DotName MCP_EXTENSION = DotName.createSimple(McpExtension.class);
    static final DotName MCP_EXTENSION_METHOD = DotName.createSimple(McpExtensionMethod.class);
    static final DotName MCP_EXTENSION_METHOD_ARG = DotName.createSimple(McpExtensionMethodArg.class);
    static final DotName MCP_EXTENSION_SETTING = DotName.createSimple(McpExtensionSetting.class);
    static final DotName MCP_EXTENSION_SETTINGS = DotName.createSimple(McpExtensionSetting.McpExtensionSettings.class);
