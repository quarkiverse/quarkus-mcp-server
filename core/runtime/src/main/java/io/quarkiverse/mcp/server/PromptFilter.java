...
/**
 * Any CDI bean that implements this interface is used to determine the set of visible/accessible prompts for a specific MCP
 * client.
 * <p>
...
public interface PromptFilter {
    ...
    /**
     * Returns {@code true} if the given prompt should be considered visible/accessible for a specific MCP client.
     * <p>
