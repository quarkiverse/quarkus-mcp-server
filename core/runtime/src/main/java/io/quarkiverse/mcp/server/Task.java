 ...
 * <p>
 * The tasks extension is advertised automatically under {@code capabilities.extensions} for every server configuration that
 * exposes at least one task-augmented tool.
 *
 * @see TaskContext
 * @see TaskManager
 */
