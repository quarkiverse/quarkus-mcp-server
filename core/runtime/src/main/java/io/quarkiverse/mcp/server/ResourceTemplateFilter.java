...
/**
 * Any CDI bean that implements this interface is used to determine the set of visible/accessible resource templates for a
 * specific MCP client.
 * <p>
...
public interface ResourceTemplateFilter {
    ...
    /**
     * Returns {@code true} if the given resource template should be considered visible/accessible for a specific MCP client.
     * <p>
