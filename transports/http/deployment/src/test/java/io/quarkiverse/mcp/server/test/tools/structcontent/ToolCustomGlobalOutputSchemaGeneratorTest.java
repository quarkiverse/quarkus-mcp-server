...
public class ToolCustomGlobalOutputSchemaGeneratorTest extends McpServerTest {
    ...
    public void testContents() {
        ...
        client.when()
                .toolsList(page -> {
                    ...
                    assertEquals("bazzz", alphaSchema.getJsonObject("properties").getJsonObject("val").getString("foo"));
                    ...
                    assertEquals("bazzz", charlieSchema.getJsonObject("properties").getJsonObject("val").getString("foo"));
    ...
    @Singleton
    public static class MyGlobalSchemaGenerator implements GlobalOutputSchemaGenerator {
